...
public class PartiallyUpdateBookingTests {

    /**
     * partially update booking - positive scenario
     **/

    @Test
    public void updateBookingAllValid(){
        Booking booking = bookingBuilder("test","bratu",null,null,null,null, null);
        Response response = partiallyUpdateBooking(booking,headerBuilder("valid","valid","valid",null),"1");
        assertThat(response.getStatusCode(), equalTo(200));
        assertThat(response.path("firstname"), equalTo("test"));
    }

    /**
     * partially update booking - negative scenarios - headers
     **/
    ...
    public void updateBookingNoContentTypeValidAcceptCookieAuth(){
        ...
        Booking booking = bookingBuilder("test","bratu",null,null,null,null, null);
        Response response = partiallyUpdateBooking(booking,headerBuilder("missing","valid","valid",token),"1");
        assertThat(response.getStatusCode(), equalTo(200));
    }
    ...
    public void updateBookingNoAcceptValidContentTypeCookieAuth(){
        ...
        String token = retrieveToken(validCredentials, headerBuilder("valid", "missing", "missing", null));
        Booking booking = bookingBuilder("test","bratu",null,null,null,null, null);
        Response response = partiallyUpdateBooking(booking,headerBuilder("valid","missing","valid",token),"1");
        assertThat(response.getStatusCode(), equalTo(200));
    }
    ...
    public void updateBookingNoAuthValidContentTypeAcceptCookie(){
        ...
        String token = retrieveToken(validCredentials, headerBuilder("valid", "missing", "missing", null));
        Booking booking = bookingBuilder("test","bratu",null,null,null,null, null);
        Response response = partiallyUpdateBooking(booking,headerBuilder("valid","valid","missing",token),"1");
        assertThat(response.getStatusCode(), equalTo(200));
    }
    ...
    public void updateBookingNoHeaders(){
        Booking booking = bookingBuilder("test","bratu",null,null,null,null, null);
        Response response = partiallyUpdateBooking(booking,headerBuilder("missing","missing","missing",null),"1");
    ...
    public void updateBookingInvalidContentTypeValidAcceptCookieAuth(){
        TokenGenerationCredentials validCredentials = new TokenGenerationCredentials("admin", "password123");
        String token = retrieveToken(validCredentials, headerBuilder("valid", "missing", "missing", null));
        Response response = partiallyUpdateBooking(validPartialUpdateBookingBody,headerBuilder("invalid","valid","valid",token),"1");
    ...
    public void updateBookingInvalidAcceptValidContentTypeCookieAuth(){
        ...
        String token = retrieveToken(validCredentials, headerBuilder("valid", "missing", "missing", null));
        Booking booking = bookingBuilder("test","bratu",null,null,null,null, null);
        Response response = partiallyUpdateBooking(booking,headerBuilder("valid","invalid","valid",token),"1");
        assertThat(response.getStatusCode(), equalTo(200));
    }
    ...
    public void updateBookingInvalidAuthValidContentTypeAcceptCookie(){
        ...
        String token = retrieveToken(validCredentials, headerBuilder("valid", "missing", "missing", null));
        Booking booking = bookingBuilder("test","bratu",null,null,null,null, null);
        Response response = partiallyUpdateBooking(booking,headerBuilder("valid","valid","invalid",token),"1");
        assertThat(response.getStatusCode(), equalTo(200));
    }
    ...
    public void updateBookingInvalidCookieValidContentTypeAcceptAuth(){
        Booking booking = bookingBuilder("test","bratu",null,null,null,null, null);
        Response response = partiallyUpdateBooking(booking,headerBuilder("valid","valid","invalid","12345"),"1");
        assertThat(response.getStatusCode(), equalTo(403));
    }

    @Test
    public void updateBookingAllInvalid(){
        Response response = partiallyUpdateBooking(validPartialUpdateBookingBody,headerBuilder("invalid","invalid","invalid","12345"),"1");
        assertThat(response.getStatusCode(), equalTo(400));
    }
    ...
    public void updateBookingMissingIdParam(){
        Booking booking = bookingBuilder("test","bratu",null,null,null,null, null);
        Response response = partiallyUpdateBooking(booking,headerBuilder("valid","valid","valid",null),null);
    ...
    public void updateBookingInvalidIdParam(){
        Booking booking = bookingBuilder("test","bratu",null,null,null,null, null);
        Response response = partiallyUpdateBooking(booking,headerBuilder("valid","valid","valid",null),"red");
    ...
    public void updateBookingMissingFirstName(){
        Booking booking = bookingBuilder(null,"bratu1",null,null,null,null, null);
        Response response = partiallyUpdateBooking(booking,headerBuilder("valid","valid","valid",null),"1");
        assertThat(response.getStatusCode(), equalTo(200));
    }
    ...
    public void updateBookingMissingLastName(){
        Booking booking = bookingBuilder(null,"bratu2",null,null,null,null, null);
        Response response = partiallyUpdateBooking(booking,headerBuilder("valid","valid","valid",null),"1");
        assertThat(response.getStatusCode(), equalTo(200));
    }
    ...
    public void updateBookingMissingTotalPrice(){
        Booking booking = bookingBuilder("test","bratu3",null,null,null,null, null);
        Response response = partiallyUpdateBooking(booking,headerBuilder("valid","valid","valid",null),"1");
        assertThat(response.getStatusCode(), equalTo(200));
    }
    ...
    public void updateBookingMissingDepositPaid(){
        Booking booking = bookingBuilder("test","bratu4",null,null,null,null, null);
        Response response = partiallyUpdateBooking(booking,headerBuilder("valid","valid","valid",null),"1");
        assertThat(response.getStatusCode(), equalTo(200));
    }
    ...
    public void updateBookingMissingCheckin(){
        Booking booking = bookingBuilder("test","bratu5",null,null,null,null, null);
        Response response = partiallyUpdateBooking(booking,headerBuilder("valid","valid","valid",null),"1");
        assertThat(response.getStatusCode(), equalTo(200));
    }
    ...
    public void updateBookingMissingCheckout(){
        Booking booking = bookingBuilder("test","bratu6",null,null,null,null, null);
        Response response = partiallyUpdateBooking(booking,headerBuilder("valid","valid","valid",null),"1");
        assertThat(response.getStatusCode(), equalTo(200));
    }
    ...
    public void updateBookingMissingAdditionalNeeds(){
        Booking booking = bookingBuilder("test","bratu7",null,null,null,null, null);
        Response response = partiallyUpdateBooking(booking,headerBuilder("valid","valid","valid",null),"1");
        assertThat(response.getStatusCode(), equalTo(200));
    }
    ...
    /**
     * partially update booking - negative scenarios - invalid body parts
     **/

    @Test
    public void updateBookingInvalidFirstName(){
        HashMap<String, Object> invalidBooking = new HashMap<>();
        invalidBooking.put("test","irina");
        Response response = partiallyUpdateBooking(invalidBooking,headerBuilder("valid","valid","valid",null),"1");
        assertThat(response.getStatusCode(), equalTo(400));
    }
